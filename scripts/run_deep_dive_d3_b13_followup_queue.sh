...
run_id="20260718_kuaisearch_mech_d3_q2_attention_edges_b13_v1"
...
for model in q3 q2; do
  ...
  run_id="20260718_kuaisearch_mech_d3_${model}_attention_heads_b13_v1"
  run_resumable "$run_id" \
    "$python_bin" scripts/observe_deep_dive_attention_heads.py \
      ...
      --device cuda:0 \
      --max-wall-seconds 13500
  run_id="20260718_kuaisearch_mech_d4_${model}_mlp_groups_b13_v1"
  run_resumable "$run_id" \
