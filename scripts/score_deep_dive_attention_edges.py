#!/usr/bin/env python3
"""Score one registered Q2/Q3 D3 attention-edge block."""
...
from myrec.mechanism.attention_edge_runtime import write_attention_edge_bundle
...
def main() -> None:
    ...
    result = write_attention_edge_bundle(
