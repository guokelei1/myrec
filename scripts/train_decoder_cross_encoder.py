#!/usr/bin/env python
"""Train one ordinary decoder-only QC or full-history reranker."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--base-model-name", default="models/huggingface/Qwen3-Reranker-0.6B"
    )
    ...
    parser.add_argument("--history-budget", type=int, default=5)
    ...
    result = train_decoder_cross_encoder(
