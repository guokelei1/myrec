#!/usr/bin/env python3
"""Aggregate all registered Q2/Q3 attention heads and KV groups."""
...
from myrec.mechanism.attention_observation_evaluator import evaluate_attention_observations
...
def main() -> None:
    ...
    result = evaluate_attention_observations(
        {
