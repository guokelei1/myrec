#!/usr/bin/env python3
"""Run one registered D4 fixed-sample MLP group localization bundle."""
...
from myrec.mechanism.mlp_group_runtime import write_mlp_group_sample_bundle
...
def main() -> None:
    ...
    result = write_mlp_group_sample_bundle(
