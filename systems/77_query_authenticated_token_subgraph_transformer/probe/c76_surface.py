"""Load C76's generator under private module names without modifying it."""
...
_cltt = _module("_c77_private_c76_cltt", C76 / "model/cltt.py")
...
try:
    _synthetic = _module("_c77_private_c76_synthetic", C76 / "probe/synthetic.py")
finally:
...
NULL_HISTORY = _synthetic.NULL_HISTORY
