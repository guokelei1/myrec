"""Freeze C64 training/evaluation sources and consumed data after G0."""
...
SOURCES = (
    ...
    "systems/64_end_to_end_lm_representation_probe/train/gate_metrics.py",
    "systems/64_end_to_end_lm_representation_probe/execution/locking.py",
    "systems/64_end_to_end_lm_representation_probe/execution/run_gate.py",
...
def main() -> None:
    ...
    if g0["status"] != "passed" or g0["g0_lock_sha256"] != g0_lock_hash:
        raise PermissionError("C64 execution lock requires passed G0")
    ...
    value = {
        ...
        "data_sha256": {
            source: sha256_file(REPO_ROOT / source) for source in data_paths(config)
        },
        "outcome_boundary": {
