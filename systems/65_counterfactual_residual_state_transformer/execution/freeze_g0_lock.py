"""Freeze C65 mechanics before label-free G0."""
...
SOURCES = (
    "systems/65_counterfactual_residual_state_transformer/configs/train_gate.yaml",
    "systems/65_counterfactual_residual_state_transformer/model/__init__.py",
    "systems/65_counterfactual_residual_state_transformer/model/counterfactual_residual.py",
    "systems/65_counterfactual_residual_state_transformer/train/__init__.py",
    "systems/65_counterfactual_residual_state_transformer/train/data_bridge.py",
    "systems/65_counterfactual_residual_state_transformer/execution/__init__.py",
    "systems/65_counterfactual_residual_state_transformer/execution/locking.py",
    "systems/65_counterfactual_residual_state_transformer/execution/freeze_g0_lock.py",
    "systems/65_counterfactual_residual_state_transformer/execution/run_g0.py",
    "systems/65_counterfactual_residual_state_transformer/tests/test_model.py",
