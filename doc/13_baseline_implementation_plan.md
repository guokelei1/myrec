...
| trainable（B3-ft/B4/B5/B6/B6+/ordinary full-token/Hxx） | outcome 前按搜索维度与成本声明，**默认 ceiling 16 次** | 小型固定 recipe 通常 4--8 次且不要求用完；Hxx 还须先通过 doc/31 Failure Card；score-affecting trial 全计数 |
